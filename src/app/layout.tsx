...
// as tested, this is the root layout, which acts as top level entry point for the app
// any client-side navigation will be rendered different page-level component inside this layout (layout first runs, then the target page level component runs)
